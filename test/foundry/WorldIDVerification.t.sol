...
contract WorldIDVerificationTest is Test {
    ...
    function setUp() public {
        ...
        Election.Candidate[] memory candidates = new Election.Candidate[](3);
        candidates[0] = Election.Candidate({
            id: 1,
            name: "Alice Johnson",
            description: "Community leader",
            active: true
        });
        candidates[1] = Election.Candidate({
            id: 2,
            name: "Bob Smith",
            description: "Tech advocate",
            active: true
        });
        candidates[2] = Election.Candidate({
            id: 3,
            name: "Carol Davis",
        ...
        ElectionManager.ElectionInfo memory electionInfo = electionManager.elections(electionId);
        election = Election(electionInfo.electionAddress);
        vm.stopPrank();
