...
async function main() {
  ...
  try {
    ...
    const newElectionCount = await electionManager.getElectionCount();
    console.log("📊 Total elections:", newElectionCount.toString());

    const election = await electionManager.getElection(newElectionCount);
    console.log("\n📋 Election Details:");
